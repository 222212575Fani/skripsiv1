    ...
    <div class="space-y-8">
        ...
        @if($role == 'direktur')
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                {{-- Pastikan komponen x-statcard sudah kamu buat ya --}}
                <x-statcard label="Total Tim Aktif" value="12" color="indigo" />
                <x-statcard label="Progres Keseluruhan" value="78%" color="emerald" />
                <x-statcard label="Target Bulanan" value="95%" color="amber" />
            </div>
