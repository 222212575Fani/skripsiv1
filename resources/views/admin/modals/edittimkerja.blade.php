        ...
        <div @click.away="open = false" 
            ...
            <form action="{{ url('admin/manajementimkerja/update') }}" method="POST" autocomplete="off">
                ...
                <div class="p-4 sm:p-8 space-y-4 sm:space-y-5">
                    ...
                    {{-- Dropdown Kustom Ketua Tim Buka ke Atas agar TIDAK Keluar Container Modal --}}
                    <div class="relative">
                            ...
                            @foreach($users as $user)
                                ...
                                @if($teamLed)
                                    ...
                                    <button type="button" 
                                        ...
                                        <span class="text-[10px] text-purple-700 bg-purple-50 border border-purple-200/60 px-2 py-0.5 rounded-full font-semibold shrink-0 ml-2">Ketua Saat Ini</span>
                                    </button>
                                @else
