                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
                        ...
                        <div class="relative">
                            ...
                            <div x-show="openStatusDropdown" x-cloak class="absolute left-0 mt-2 w-full bg-white border border-purple-100 rounded-[20px] shadow-xl p-2 z-50 space-y-1">
                                ...
                                <button type="button" @click="status = 'pending'; statusName = 'Pending'; openStatusDropdown = false;" class="w-full text-left px-3 py-2 rounded-xl text-xs text-gray-700 hover:bg-purple-50 hover:text-[#5C46F5] font-normal transition-all cursor-pointer">Pending</button>
