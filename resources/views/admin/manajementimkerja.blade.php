        ...
        <div class="flex flex-col gap-4">
            ...
            <div class="bg-white rounded-[20px] shadow-sm border border-gray-100 overflow-hidden mt-2">
                ...
                <div id="data-container" class="px-4 pb-4">
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="text-gray-400 text-[10px] uppercase tracking-widest font-bold border-b border-gray-100">
                                ...
                                <th class="px-6 py-6 w-[20%]">Nama Tim</th>
                                <th class="px-6 py-6 w-[35%]">Deskripsi Tim Kerja</th>
                        ...
                        <tbody class="font-medium text-sm">
                            ...
                            <tr class="group hover:bg-gray-50/50 transition-all duration-200 border-t border-gray-50 align-top">
                                <td class="px-6 py-6 text-center text-gray-400 font-bold border-l-4 border-l-transparent group-hover:border-l-[#5C46F5] transition-all">{{ $timKerja->firstItem() + $index }}</td>
                                <td class="px-6 py-6 font-bold text-gray-800 break-words">{{ $tim->nama_tim }}</td>
                                
                                {{-- Deskripsi: text-sm, font-medium, text-justify --}}
                                <td class="px-6 py-6 text-sm text-gray-600 leading-relaxed whitespace-normal break-words font-medium text-justify">
                                ...
                                <td class="px-6 py-6">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <span class="font-bold text-gray-800 break-words">{{ $tim->ketua->nama ?? 'Tidak Ada' }}</span>
                                    </div>
                                </td>
                    ...
                    {{-- Paginasi: Font medium (bukan bold) --}}
                    <div class="mt-4 pt-6 border-t border-gray-50 flex items-center justify-between px-6 text-[11px] font-medium text-gray-400 uppercase tracking-widest">
