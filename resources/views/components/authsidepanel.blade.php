<div class="relative overflow-hidden rounded-[22px] bg-linear-to-br from-[#8FD0FF] via-[#4D5BFF] to-[#D9E8F7]">
    ...
    <div class="relative h-full flex flex-col justify-between gap-6 md:gap-0 p-8 md:p-10 text-white">
        ...
        <div class="hidden md:block text-[14px] text-white/90">
