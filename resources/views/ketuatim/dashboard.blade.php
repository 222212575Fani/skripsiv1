                ...
                <div class="flex flex-wrap items-center gap-3 w-full md:w-auto">
                    ...
                    <div class="relative group/filter">
                        <button @click="filterOpen = !filterOpen" @click.outside="filterOpen = false" type="button" 
                            class="flex items-center justify-between gap-3 px-4 py-2.5 bg-white hover:bg-[#F8F7FF] border border-gray-200 hover:border-[#5C46F5] text-gray-500 hover:text-[#5C46F5] rounded-2xl text-xs font-normal transition-all cursor-pointer min-w-[180px]">
                        ...
                        <div x-show="filterOpen" x-cloak 
                            ...
                            <div class="px-3 py-2 border-b border-gray-100 flex items-center gap-2 text-[#5C46F5] font-normal text-xs">
                            ...
                            <button @click="status = 'semua'; filterOpen = false; fetchProjects();" 
                                ...
                                <span class="px-2.5 py-0.5 rounded-full text-[11px] font-normal" :class="status === 'semua' ? 'bg-indigo-100/80 text-[#5C46F5]' : 'bg-gray-100 text-gray-600'">
                                    {{ $totalProyek }}
                                </span>
                            </button>
                            ...
                            <button @click="status = 'belum_dimulai'; filterOpen = false; fetchProjects();" 
                                ...
                                <span class="px-2.5 py-0.5 rounded-full text-[11px] font-normal" :class="status === 'belum_dimulai' ? 'bg-indigo-100/80 text-[#5C46F5]' : 'bg-gray-100 text-gray-600'">
                                    {{ $belumDimulai }}
                                </span>
                            </button>
                            ...
                            <button @click="status = 'berjalan'; filterOpen = false; fetchProjects();" 
                                ...
                                <span class="px-2.5 py-0.5 rounded-full text-[11px] font-normal" :class="status === 'berjalan' ? 'bg-indigo-100/80 text-[#5C46F5]' : 'bg-gray-100 text-gray-600'">
                                    {{ $berjalan }}
                                </span>
                            </button>
                            ...
                            <button @click="status = 'selesai'; filterOpen = false; fetchProjects();" 
                                ...
                                <span>Selesai</span>
                                <span class="px-2.5 py-0.5 rounded-full text-[11px] font-normal" :class="status === 'selesai' ? 'bg-indigo-100/80 text-[#5C46F5]' : 'bg-gray-100 text-gray-600'">
                                    {{ $selesai }}
                                </span>
                            </button>
                            ...
                            <button @click="status = 'terlambat'; filterOpen = false; fetchProjects();" 
                                ...
                                <span>Terlambat</span>
                                <span class="px-2.5 py-0.5 rounded-full text-[11px] font-normal" :class="status === 'terlambat' ? 'bg-indigo-100/80 text-[#5C46F5]' : 'bg-gray-100 text-gray-600'">
                                    {{ $terlambat }}
                                </span>
                            </button>
