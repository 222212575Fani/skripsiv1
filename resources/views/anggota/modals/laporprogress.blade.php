                ...
                <div class="p-7 space-y-4 max-h-[70vh] overflow-y-auto">
                    ...
                    <div>
                        ...
                        <div class="relative border-2 border-dashed border-purple-200 hover:border-[#6E5BC3] rounded-2xl p-6 bg-purple-50/20 hover:bg-purple-50/50 transition-all text-center cursor-pointer group">
                            <input type="file" id="dokumen_input" name="dokumen_pendukung[]" multiple @change="handleFileChange($event)" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer z-10">
                            ...
                            <div class="flex flex-col items-center justify-center space-y-2">
                                ...
                                <div class="text-xs text-gray-600 font-medium">Choose a file or drag & drop it here</div>
